...
namespace LoanWorkflow.DAL.Migrations
{
    ...
    [Migration("20240315093046_LoanSettingAddProvissionMaxPercent")]
    partial class LoanSettingAddProvissionMaxPercent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LoanWorkflow.DAL.Entities.Loan.LoanType", b =>
                {
                    b.HasOne("LoanWorkflow.DAL.Entities.Loan.LoanType", "Parent")
                        .WithOne()
                        .HasForeignKey("LoanWorkflow.DAL.Entities.Loan.LoanType", "ParentId")
                        .OnDelete(DeleteBehavior.NoAction);
